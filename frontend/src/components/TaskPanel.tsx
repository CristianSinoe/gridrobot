    ...
    <section className={`panel task-panel task-panel--${viewMode}`}>
      ...
      <div className="task-list task-list--mission">
        ...
        {pendingTasks.map((task) => (
          <article
            key={task.id}
            className={`task-item task-item--mission${selectedTaskId === task.id ? " is-selected" : ""}`}
            onClick={() => {
          ...
          >
            <div className="task-item__main">
              ...
              <div className="task-item__headline">
                <div>
                  ...
                  <h3>{task.name}</h3>
                  <p className="task-item__summary">
            ...
            <div className="task-item__actions">
              ...
              {viewMode === "operator" ? (
                selectedTaskId === task.id && (task.status === "PENDING" || task.status === "WAITING_ASSISTANCE") ? (
